...
c_concat_mp3_sh='~/.config/mpv/scripts/c_concat_mp3.sh'
...
function output_queue_mp3()
	...
	then
		...
		--os.execute(mkdir_sh)
		os.execute(shell_str)
		print('shell:'..c_concat_mp3_sh .. ' '..output_file..' "'..video_path..'" '..output_dir)
		os.execute(c_concat_mp3_sh .. ' "'..output_file..'" "'..video_path..'" "'..output_dir..'" "'..run_dir..'"')
		os.execute(run_sh)

	end
end
mp.add_key_binding("O", "output_queue_mp3", output_queue_mp3)
